<div class="row">
    ...
    <div class="col-md-3">
        <div class="list-group">
          ...
          <a href="<?php echo url_for('private/Contacto/contacto.php'); ?>" <?php if ($page_title=='Contacto') {echo "class='list-group-item active'";}else {echo "class='list-group-item'";}?>>Contactos</a>
