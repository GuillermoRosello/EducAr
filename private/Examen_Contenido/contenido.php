...
<?php $alumnos = alumnos(); ?>
	<!-- Content Row -->
	<form action="../Alumnos - Copy/nuevo_alumno.php" method="post">
	<input type="submit" value="Nuevo Alumno" class="btn btn-primary"><br><br>
		...
		<table class="display" id="mitabla">
			...
			<tbody><?php while($alumno = mysqli_fetch_assoc($alumnos)){ ?><tr>
				...
				<!-- Pablo -->
				<td><a href="<?php echo '../Alumnos - Copy/editar_alumno.php?id='.$alumno['alumno_id'];?>" title="Editar"><span class="glyphicon glyphicon-pencil"></span></a></td>
				<!-- Pablo -->
				<td><a href="<?php echo '../Alumnos - Copy/eliminar_alumno.php?id='.$alumno['alumno_id'];?>" title="Borrar"><span class="glyphicon glyphicon-trash"></span></a></td>
				</tr>
				<?php }; ?>
			</tbody>
		</table>
