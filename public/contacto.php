...
<?php $page_subtitle ='Info General'; ?>
...
<?php include('shared/public_navigation.php'); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <!-- Embedded Google Map -->
                <iframe width="100%" height="400px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com/maps?hl=es&amp;ie=UTF8&amp;ll=-32.9422596,-60.65303699999998&amp;t=m&amp;z=18&amp;output=embed"></iframe>
            </div>
            ...
            <div class="col-md-4">
                ...
                <p><i class="fa fa-envelope-o"></i>
                    <abbr title="Email"></abbr><a href="mailto:name@example.com">info@examin.ar</a>
                </p>
                <p><i class="fa fa-clock-o"></i>
                    <abbr title="Hours"></abbr>Lunes a Viernes: de 9:00 a 19:00</p>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Solicitud de Contacto
                <small>Elija el tipo de examen que desea realizar.</small>
                </h2>
            </div>
            <div class="col-lg-12">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade active in" id="service-one">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <br>
                                <form name="sentMessage" id="contactForm" action="../private/Functions/thankyou.php" method="post" >
